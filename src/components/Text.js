...
function Text({ children, size = 1, left, right, top, bottom, color = "white", opacity = 1, height = 0.01, layers = 0, /*font = "sans-serif",*/ ...props }) {
  ...
  return (
    <group {...props} scale={[size, size, 0.1]}>
      <mesh  /*geometry={geom} */
       onUpdate={onUpdate} frustumCulled={false}>
